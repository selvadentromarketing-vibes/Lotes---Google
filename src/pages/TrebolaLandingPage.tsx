...
import { STARTING_PRICE_USD, formatPrice, PRICING_FOOTNOTE } from '../config/pricing';
import { translations } from '../config/translations';

export default function TrebolaLandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#ECE5D8]">
      ...
      {/* HERO SECTION */}
      <div className="relative min-h-screen flex items-center pt-16 bg-gradient-to-b from-brand-dark-green via-brand-dark-green/95 to-brand-dark-green/90">
        <div className="relative w-full px-4 sm:px-6 lg:px-8 py-20">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white leading-tight mb-2 max-w-5xl">
              <span className="text-brand-copper">{formatPrice(STARTING_PRICE_USD, 'USD')}*</span>
            </p>

            <p className="text-xl sm:text-2xl text-white/90 mb-12 max-w-5xl">
              {t.hero.headlinePrice}
            </p>

            <div className="mb-12 max-w-4xl">
              <VSL mediaId="24jgf67xcz" language="en" />
            </div>
      ...
      {/* MASTER PLAN SECTION */}
      <div id="masterplan" className="relative bg-white py-24 sm:py-32">
      ...
      <div id="advantages" className="relative bg-[#ECE5D8] py-24 sm:py-32">
...
<div className="relative bg-[#ECE5D8] py-24 sm:py-32">
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div className="grid md:grid-cols-3 gap-8 mb-16">
      <div className="flex items-center justify-center h-20 md:h-28 py-2">
        <img
          src="/development_company_logo-jjf_creando.webp"
          alt="JJF Creando"
          className="block max-h-full max-w-[220px] md:max-w-[260px] w-auto object-contain object-center"
        />
      </div>
